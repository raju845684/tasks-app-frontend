...
import { FaCog, FaUser, FaLock, FaCheck } from "react-icons/fa";
...
const Settings = () => {
  ...
  const avatarSrc = user?.avatar ||
    `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.name || "U")}&background=f87171&color=fff&size=80`;
      ...
      <div className="max-w-2xl space-y-5">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
          ...
          <div className="flex items-center gap-4 mb-5 p-4 bg-gray-50 rounded-xl">
            <img src={avatarSrc} alt={user?.name} className="w-16 h-16 rounded-full object-cover border-2 border-white shadow" />
            <div>
          ...
          {profileMsg && (
            <div className={`mb-4 px-4 py-2.5 rounded-xl text-sm flex items-center gap-2 ${
              profileMsg.type === "success" ? "bg-green-50 text-green-600 border border-green-200" : "bg-red-50 text-red-600 border border-red-200"
            }`}>
          ...
          <form onSubmit={handleProfileSave}>
            ...
            <button
              ...
              className="px-6 py-2.5 rounded-xl text-white text-sm font-semibold disabled:opacity-50 transition"
        ...
        {user?.provider !== "google" && (
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            {passwordMsg && (
              <div className={`mb-4 px-4 py-2.5 rounded-xl text-sm flex items-center gap-2 ${
                passwordMsg.type === "success" ? "bg-green-50 text-green-600 border border-green-200" : "bg-red-50 text-red-600 border border-red-200"
              }`}>
